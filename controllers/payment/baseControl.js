    ...
    function BaseControl() {
        ...
        this.insert = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.model
                    .findOne({ where: { paymentId: req.body.paymentId } })
        ...
        this.get = function (req, res) {
            ...
            _this.model
                .findOne({ where: { paymentId: req.params.id } })
                ...
                var data = {
                    ...
                    paymentGateway: order.dataValues.paymentGateway,
                    paymentStatus: order.dataValues.paymentStatus
                };
                res.status(200).json(data);
            })["catch"](function (err) {
                if (err) {
        ...
        // Get by id
        this.getByOrder = function (req, res) {
            if (!parseJwt(req.headers.authorization)) {
                return res.status(403).json({ error: "No credentials sent!" });
            }
            _this.model
                ...
                var data = {
                    customerId: order.dataValues.customerId,
                    paymentId: order.dataValues.paymentId,
                    orderId: order.dataValues.orderId,
                    totalAmount: order.dataValues.totalAmount,
                    paymentGateway: order.dataValues.paymentGateway,
                    paymentStatus: order.dataValues.paymentStatus
