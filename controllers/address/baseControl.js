...
var BaseControl = /** @class */ (function () {
    function BaseControl() {
        ...
        // Get all
        this.getAllCustomerAddress = function (req, res) {
            if (!parseJwt(req.headers.authorization)) {
                return res.status(403).json({ error: "No credentials sent!" });
            }
            _this.model
        ...
        this.insert = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.model
                    .findOne({ where: { addressId: req.body.addressId } })
        ...
        this.get = function (req, res) {
            ...
            _this.model
                .findOne({ where: { addressId: req.params.id } })
                .then(function (address, err) {
                if (!address) {
                ...
                var data = {
                    name: address.dataValues.name,
                    addressLineOne: address.dataValues.addressLineOne,
                    addressLineTwo: address.dataValues.addressLineTwo,
                    addressLineThree: address.dataValues.addressLineThree,
                    city: address.dataValues.city,
                    state: address.dataValues.state,
                    country: address.dataValues.country,
                    postCode: address.dataValues.postCode,
