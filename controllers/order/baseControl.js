    ...
    function BaseControl() {
        ...
        this.insert = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.model
                    .findOne({ where: { orderId: req.body.orderId } })
        ...
        this.get = function (req, res) {
            ...
            _this.model
                ...
                var data = {
                    ...
                    productDetails: order.dataValues.productDetails,
                    shippingAddress: order.dataValues.shippingAddressId,
                    billingAddress: order.dataValues.billingAddressId,
                    price: order.dataValues.price,
                    status: order.dataValues.status,
                    paymentMode: order.dataValues.paymentMode,
                    purchaseDateTime: order.dataValues.purchaseDateTime,
                    allData: order.dataValues.allData
                };
                res.status(200).json(data);
            })["catch"](function (err) {
                if (err) {
        ...
        // Get by id
        this.getCustomerOrders = function (req, res) {
            if (!parseJwt(req.headers.authorization)) {
                return res.status(403).json({ error: "No credentials sent!" });
            }
            _this.model
